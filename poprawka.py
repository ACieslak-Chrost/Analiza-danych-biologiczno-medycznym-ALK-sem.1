# -*- coding: utf-8 -*-
"""
Created on Thu Apr  9 09:07:30 2026
...
"""
#Funkcjonalności GUI:
#✅ Wczytywanie CSV/Excel przez okno dialogowe
#✅ Wybór parametru do analizy
#✅ Tabela z wynikami statystycznymi
#✅ Wykresy (boxplot + punkty)
#✅ Eksport do CSV i SQLite
...
class MedicalAnalyzer:
    ...
    def export_csv(self):
        ...
        if f:
            ...
            self.export_info.insert(tk.END, f"✓ Zapiasano: {f}\n")
    ...
    def export_sql(self):
        ...
        if f:
            ...
            conn.close()
            self.export_info.insert(tk.END, f"✓ Zapiasano bazę: {f}\n")
