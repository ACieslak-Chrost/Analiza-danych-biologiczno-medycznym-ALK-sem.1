...
Wersja: 10.2 - Poprawiona i działająca
Autor: Aneta
"""
...
class MedicalAnalyzerGUI:
    def __init__(self, root):
        ...
        self.pro_btn = None  # Referencja do przycisku profesjonalnego
...
"""
    ...
    def tab2_analiza(self):
        ...
        # Tabela wyników (reszta kodu bez zmian)
...
"""
    ...
    def tab5_info(self):
        ...
        info_text = """
╔══════════════════════════════════════════════════════════════╗
║         ANALIZATOR DANYCH MEDYCZNYCH - WERSJA 10.2          ║
╚══════════════════════════════════════════════════════════════╝
...
if __name__ == "__main__":
    ...
    root.mainloop()
# =============================================================================
# ZAKŁADKA 6 - KALKULATOR RYZYKA HOSPITALIZACJI
# =============================================================================
def tab6_kalkulator(self):
    ...
    # Słownik do przechowywania zmiennych wejściowych
    self.entry_vars = {}
    
    # Tworzenie pól dla kluczowych parametrów (top 5 z analizy)
    parametry_do_kalkulatora = [
        ("wiek", "Wiek (lata)", 0, 120, "years"),
        ("SpO2", "Saturacja (%)", 0, 100, "percentage"),
        ("crp(0-0,5)", "CRP (mg/dL)", 0, 500, "units"),
        ("MAP", "MAP (mmHg)", 0, 200, "pressure"),
        ("kreatynina(0,5-1,2)", "Kreatynina (mg/dL)", 0, 20, "units")
    ]
    ...
    diseases = [
        ...
        ("wątroba", "Choroba wątroby"),
        ("naczyniowe", "Choroby naczyniowe"),
        ("zza", "Zespół zakrzepowo-zatorowy"),
        ("npl", "Nowotwór")
    ]
...
def oblicz_prawdopodobienstwo(self):
    ...
    if not hasattr(self, 'model_predykcyjny_model') or self.model_predykcyjny_model is None:
        messagebox.showwarning("⚠️ Uwaga", 
    ...
    try:
        ...
        # Predykcja
        prob = self.model_predykcyjny_model.predict_proba(X_pred_scaled)[0, 1]
        ...
        self.risk_canvas.create_rectangle(0, 0, prob_percent * 3, 30,
                                         fill=kolor,
                                         outline='')
        self.risk_canvas.create_text(prob_percent * 3 + 10, 15,
                                    text=f"{prob_percent:.1f}%",
                                    anchor='w',
                                    font=('Helvetica', 10, 'bold'))
        
        # Dodaj linię podziału
        self.risk_canvas.create_line(90, 0, 90, 30, fill='black', dash=(2, 2))  # 30%
        self.risk_canvas.create_line(180, 0, 180, 30, fill='black', dash=(2, 2))  # 60%
