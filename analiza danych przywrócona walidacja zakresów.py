# -*- coding: utf-8 -*-
"""
Created on Thu Apr  9 10:12:37 2026
...
Wersja: 20.1 - POPRAWKI: df_caly i walidacja zakresów
Autor: Aneta
"""
...
def przygotuj_dane_z_outcome(df, id_pacjenta=None):
    """Przygotowuje dane z kolumną outcome - zwraca df_caly"""
    df_copy = df.copy()
    ...
    df_caly = df_copy.copy()  # TU JEST df_caly
...
# =============================================================================
# 5️⃣ ANALIZA JEDNOCZYNNIKOWA Z FDR
# =============================================================================
...
def main(sciezka_pliku):
    ...
    print("\n" + "="*80)
    print("🏥 PROFESJONALNA ANALIZA DANYCH MEDYCZNYCH - WERSJA 20.1")
    print("="*80)
    ...
    # =========================================================================
    # 3. KONTROLA JAKOŚCI - PRZYWRÓCONA!
    # =========================================================================
    ...
    # =========================================================================
    # 6. RAPORT MISSINGNESS DLA TOP 5
    # =========================================================================
